...
//		System.out.println(events[i].toString());	// TODO Auto-generated method stub
		...
		public static  boolean nyevent(int eventkod, String eventdescr,
			...
			/*#
			prepare data to bee written in a String
			hämta aktuell tidpunkt;
			String handelsetidpunkt = 
			*/
			
			param[1] = " 01 ; "+ idag.toString()+" "+ now.toString()+" ; ";
			param[2] = " 02  ; " + eventkod+" ; ";
			...
			line =param[1]+param[2]+param[3]+param[4]+param[5];
				 ...
				 *skriv ett post parametrar på formatet "X  parametervalue \n"
				 *
				 */
				try
				{
					...
					/*
					 * use 
					 * skriv sedan till filen till exempel med en forlloop
					 * 
					 */
...
//				System.out.println("sparat: " + isOK);
		...
		public static boolean nollalogglist()
		{
			...
			try
			{
				...
				/*
				 * use 
				 * skriv sedan null i den befintliga filen 
				 * 
				 */
