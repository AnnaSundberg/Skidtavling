...
public class Eventlogg {
	...
	public String toString() {
		return "Nr:" + eventID + ", Tid:" + handelsetidpunkt + ", Kod:" + eventkod
				+ ", beskr.:" + eventdescr + ", Rapportör:" + eventsrce + ", Inblandad:" + eventobj ;
	}
	@Override
	public int hashCode() {
...
//	
//		  STARTCOMP,		//1.TÄVLANDESTART
//		  INERMEDIATETIM,	//2.MELLANTID
//		  FINALTIM,			//3.MÅLGÅNG
//		  COMPABORT,		//4.TÄVLANDE,TÄVLINGAVBRUTEN
//		  COMPACC,			//5.INCIDENT I TÄVLINGEN
//		  AUXEVENT,			//6.ANNAN HÄNDELSE
//		  OMSTART
//		}
//
